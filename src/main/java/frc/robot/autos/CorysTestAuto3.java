...
public class CorysTestAuto3 extends SequentialCommandGroup {
  ...
  public CorysTestAuto3(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      // Close Ring
      InitialPose("CorysTotallyCoolAuto1", false),
      new ManualShoot(Arm, 120),
      ChoreoPathingWithIntake("CorysTotallyCoolAuto1", false, m_Arm, m_Intake),
      new ManualShoot(Arm, 120),
      ChoreoPathing("CorysTotallyCoolAutoVersion2", false),
      DriveToNote(m_Arm, m_Intake),
      ChoreoPathingWithIntake("CorysTotallyCoolAutoVersion2(2)", false, m_Arm, m_Intake),
      new ManualShoot(m_Arm, 150),
      ChoreoPathing("CorysTotallyCoolAuto2", false),
      DriveToNote(m_Arm, m_Intake),
      ChoreoPathingWithIntake("CorysTotallyCoolAuto3", false, m_Arm, m_Intake),
