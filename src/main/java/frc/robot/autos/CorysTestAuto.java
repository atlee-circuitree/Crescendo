...
public class CorysTestAuto extends SequentialCommandGroup {
  ...
  public CorysTestAuto(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
