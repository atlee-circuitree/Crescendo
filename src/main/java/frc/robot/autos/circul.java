...
public class circul extends SequentialCommandGroup {
  
  Drivetrain m_drivetrain;

  public circul(Drivetrain Drivetrain, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      InitialPose("circul", false),

      ChoreoPathing("circul", false)
