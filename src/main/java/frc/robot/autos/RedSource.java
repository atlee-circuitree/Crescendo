...
public class RedSource extends SequentialCommandGroup {
  ...
  public RedSource(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      new ManualShoot(m_Arm, 120),
      ChoreoPathingWithIntake("SourceLimelight5",true, m_Arm, m_Intake),
      DriveToNote(m_Arm, m_Intake),
      ChoreoPathingWithIntake("SourceLimelight6",true, m_Arm, m_Intake),
      new ManualShoot(m_Arm, 120)
