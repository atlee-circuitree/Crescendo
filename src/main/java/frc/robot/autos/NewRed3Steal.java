...
public class NewRed3Steal extends SequentialCommandGroup {
  ...
  public NewRed3Steal(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
    ...
    addCommands(
      InitialPose("NewBlue", true),
      ChoreoPathing("NewBlue", true),
      new ManualShoot(m_Arm, 120),
      

      
      ChoreoPathingWithIntakeAndArm("NewBlue2_3", true, m_Arm, m_Intake, 60),
      
      new ManualShoot(m_Arm, 120),
      ChoreoPathingWithIntakeAndArm("Weird", true, m_Arm, m_Intake, 60),
     

      
      new ManualShoot(Arm, 120),
      ChoreoPathingWithIntake("Weird2", true, Arm, Intake),
      new ManualShoot(Arm,120)
