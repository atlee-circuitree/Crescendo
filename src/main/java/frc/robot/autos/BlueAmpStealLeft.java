...
public class BlueAmpStealLeft extends SequentialCommandGroup {
  
  Drivetrain m_drivetrain;

  public BlueAmpStealLeft(Drivetrain Drivetrain, Arm Arm, Intake Intake) {
