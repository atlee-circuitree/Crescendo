...
public class AmpShootBlue4 extends SequentialCommandGroup {
  
  Drivetrain m_drivetrain;
  RobotContainer m_RobotContainer;

  public AmpShootBlue4(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
