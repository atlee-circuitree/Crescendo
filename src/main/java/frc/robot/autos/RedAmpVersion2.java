...
public class RedAmpVersion2 extends SequentialCommandGroup {
  ...
  public RedAmpVersion2(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      // Close Ring
      new WaitCommand(5),
      InitialPose("AmpVersion2", true),
      ChoreoPathing("AmpVersion2", true),
