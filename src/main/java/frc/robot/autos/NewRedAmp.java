...
public class NewRedAmp extends SequentialCommandGroup {
  ...
  public NewRedAmp(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      ChoreoPathingWithIntakeAndArm("NewBlue2", true, m_Arm, m_Intake, 60),
      
      new AutoArm(m_Arm, -50),
      new ManualShoot(m_Arm, 120),
      ChoreoPathingWithIntakeAndArm("NewBlue3", true, m_Arm, m_Intake, 60),
      ...
      ChoreoPathingWithIntake("NewBlue4", true, Arm, Intake),
