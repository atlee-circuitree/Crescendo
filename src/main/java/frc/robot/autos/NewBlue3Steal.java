...
public class NewBlue3Steal extends SequentialCommandGroup {
  ...
  public NewBlue3Steal(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      ChoreoPathingWithIntakeAndArm("NewBlue2_3", false, m_Arm, m_Intake, 60),
      
      new ManualShoot(m_Arm, 120),
      ChoreoPathingWithIntakeAndArm("Weird", false, m_Arm, m_Intake, 60),
     

      
      new ManualShoot(Arm, 120),
      ChoreoPathingWithIntake("Weird2", false, Arm, Intake),
      new ManualShoot(Arm,120)
