...
public class RedCloseLeftStealLeftLineupLeft extends SequentialCommandGroup {
  
  Drivetrain m_drivetrain;

  public RedCloseLeftStealLeftLineupLeft(Drivetrain Drivetrain, Arm Arm, Intake Intake) {
