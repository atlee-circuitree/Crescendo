...
public class RedSourceSide extends SequentialCommandGroup {
  ...
  public RedSourceSide(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      InitialPose("SourceSide", true),

      // Second Shot
      new ParallelRaceGroup(
      new ManualIntake(Intake, Arm, 120),
      ChoreoPathing("SourceSide", true) 
      ),
      ...
      new ParallelRaceGroup(
      new ManualIntake(Intake, Arm, 120),
      ChoreoPathing("SourceSide2", true)
      ),
