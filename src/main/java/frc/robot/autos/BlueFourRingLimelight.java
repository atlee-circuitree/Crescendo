...
public class BlueFourRingLimelight extends SequentialCommandGroup {
  ...
  public BlueFourRingLimelight(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      ChoreoPathingWithIntake("CSLimelight1", false, m_Arm, m_Intake),
      DriveToSpeaker(m_Arm, m_Intake),
      new ManualShoot(m_Arm, 120),
      ChoreoPathing("CSLimelight3", false),
      DriveToNote(m_Arm, m_Intake),
      ChoreoPathingWithIntake("CSLimelight4", false, m_Arm, m_Intake),
      DriveToSpeaker(m_Arm, m_Intake),
      new ManualShoot(m_Arm, 120)
