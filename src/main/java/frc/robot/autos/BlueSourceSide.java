...
public class BlueSourceSide extends SequentialCommandGroup {
  
  Drivetrain m_drivetrain;
  RobotContainer m_RobotContainer;

  public BlueSourceSide(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      InitialPose("SourceSide", false),

      // Second Shot
      new ParallelRaceGroup(
      new ManualIntake(Intake, Arm, 120),
      ChoreoPathing("SourceSide", false) 
      ),
      ...
      new ParallelRaceGroup(
      new ManualIntake(Intake, Arm, 120),
      ChoreoPathing("SourceSide2", false)
      ),
