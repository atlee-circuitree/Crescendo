...
public class BackFeedTest extends SequentialCommandGroup {
  
  Drivetrain m_drivetrain;
  RobotContainer m_RobotContainer;

  public BackFeedTest(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      InitialPose("BackFeedTest", false), // Seed your inital position
      new ParallelCommandGroup( 
      new ManualIntake(Intake, Arm, 120), 
      ChoreoPathing("BackFeedTest", false)
      )
