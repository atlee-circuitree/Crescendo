...
public class BlueNewCenterShoot extends SequentialCommandGroup {
  
  Drivetrain m_drivetrain;
  RobotContainer m_RobotContainer;

  public BlueNewCenterShoot(Drivetrain Drivetrain, RobotContainer RobotContainer, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      InitialPose("NewCenterShoot", false),

      // Second Shot
      new ParallelRaceGroup(
      new ManualIntake(Intake, Arm, 120),
      ChoreoPathing("NewCenterShoot", false) 
      ),
