...
public class RedCenterStealMiddle extends SequentialCommandGroup {
  
  Drivetrain m_drivetrain;

  public RedCenterStealMiddle(Drivetrain Drivetrain, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      new ManualShoot(Arm, 70),
      ChoreoPathing("CenterStealMiddle", true),
      new ManualShoot(Arm, 70),
      ChoreoPathing("CenterStealLeft", true),
      new ManualShoot(Arm, 70)
