...
public class BlueCloseLeftStealLeftLineupLeft extends SequentialCommandGroup {
  
  Drivetrain m_drivetrain;

  public BlueCloseLeftStealLeftLineupLeft(Drivetrain Drivetrain, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      new ManualShoot(Arm, 70),
      ChoreoPathing("StealLeft", false),
      new ManualShoot(Arm, 70),
      ChoreoPathing("LineupLeft", false)
    );
