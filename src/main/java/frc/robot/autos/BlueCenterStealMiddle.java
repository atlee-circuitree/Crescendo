...
public class BlueCenterStealMiddle extends SequentialCommandGroup {
  
  Drivetrain m_drivetrain;

  public BlueCenterStealMiddle(Drivetrain Drivetrain, Arm Arm, Intake Intake) {
    ...
    addCommands(
      ...
      new ManualShoot(Arm, 70),
      ChoreoPathing("CenterStealMiddle", false),
      new ManualShoot(Arm, 70),
